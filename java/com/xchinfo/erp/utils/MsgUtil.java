...
public class MsgUtil {
    ...
    public static void main(String[] args) throws IOException,
        URISyntaxException {
            ...
            String apikey = "bd8456a7852bf05220dda209ed6a977e";

            //修改为您要发送的手机号
            String mobile = "13437106113";

            /**************** 查账户信息调用示例 *****************/
            System.out.println(MsgUtil.getUserInfo(apikey));

            /**************** 使用智能匹配模板接口发短信(推荐) *****************/
            //设置您要发送的内容(内容必须和某个模板匹配。以下例子匹配的是系统提供的1号模板）
            String text = "【云片网】您的验证码是1234";
            //发短信调用示例
//            System.out.println(MsgUtil.sendSms(apikey, text, mobile));
          ...
          /*  long tpl_id = 1;
            ...
            System.out.println(MsgUtil.tplSendSms(apikey, tpl_id, tpl_value,
                mobile));*/
    ...
    public static boolean sendSms(String text, 
        String mobile) throws IOException {
        Map < String, String > params = new HashMap < String, String > ();
        params.put("apikey", "bd8456a7852bf05220dda209ed6a977e");
        params.put("text", text);
        params.put("mobile", mobile);
        ...
        if(mapType.get("code") != null && mapType.get("code").equals("0")){
        	return true;
        }
