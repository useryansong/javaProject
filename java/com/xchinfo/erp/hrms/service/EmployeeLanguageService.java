...
import com.xchinfo.erp.hrms.mapper.EmployeeLanguageMapper;
 ...
 */
@Service
public class EmployeeLanguageService extends BaseServiceImpl<EmployeeLanguageMapper, EmployeeLanguageEO>{
    public List<EmployeeLanguageEO> getByEmployee(Long employeeId) {
