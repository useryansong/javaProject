...
import com.xchinfo.erp.mes.mapper.DubPurchaseOrderMapper;
...
@Service
public class IDubPurchaseOrderService extends BaseServiceImpl<DubPurchaseOrderMapper, PurchaseOrderEO> {
    ...
    public List<PurchaseOrderEO> getBySerialDistributeIds(String sqlStr) {
        return this.baseMapper.getBySerialDistributeIds(sqlStr);
    }
}
