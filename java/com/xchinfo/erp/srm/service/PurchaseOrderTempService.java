 ...
 */
 @Service
public class PurchaseOrderTempService extends BaseServiceImpl<PurchaseOrderMapper, PurchaseOrderEO> {
    ...
    public boolean save(PurchaseOrderEO entity) throws BusinessException {
        ...
        // 生成业务编码
        String voucherNo = this.businessCodeGenerator.generateNextCode("srm_purchase_order", entity,user.getOrgId());
    ...
    public List<PurchaseOrderEO> getBySerialIds(String sqlStr) {
        return this.baseMapper.getBySerialIds(sqlStr);
    }

    public void deleteByPurchaseOrderIds(String deleteSqlStr) {
        this.baseMapper.deleteByPurchaseOrderIds(deleteSqlStr);
    }
}
