 ...
 * @update
 */
@TableName("wf_work_item")
@KeySequence("wf_work_item")
public class WorkItemEO extends AbstractAuditableEntity<WorkItemEO> {
    private static final long serialVersionUID = 8468607934346278790L;
