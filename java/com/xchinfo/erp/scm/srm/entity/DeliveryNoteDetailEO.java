 ...
 * @date 2019/5/14
 */
@TableName("srm_delivery_note_detail")
@KeySequence("srm_delivery_note_detail")
public class DeliveryNoteDetailEO extends AbstractAuditableEntity<DeliveryNoteDetailEO> {
    private static final long serialVersionUID = 255619400262722279L;

    @TableId(type = IdType.INPUT)
    private Long deliveryNoteDetailId;/** 主键 */

    private Long deliveryNoteId;/** 送货单ID */

    private Long deliveryPlanId;/** 送货计划ID */

    private Integer status;/** 状态;0-新建;1-待送货;2-送货中;3-已完成 */

    private Double deliveryQuantity;/** 本单送货数量 */

    private Double actualReceiveQuantity;/** 本单实收数量 */
    ...
    @Length(max = 200, message = "原材料炉号长度不能超过 200 个字符")
    private String rawMaterialFurnaceNumber;/** 原材料炉号 */

    private Integer bqNumber;/** 标签数量 */
    ...
    @TableField(exist = false)
    private String voucherNo;/** 流水号(送货计划) */

    @TableField(exist = false)
    private String purchaseOrderNo;/** 订单编号 */

    @TableField(exist = false)
    private Double planDeliveryQuantity;/** 计划采购数量 */
    ...
    @TableField(exist = false)
    @JsonFormat(pattern = "yyyy-MM-dd")
    private Date planDeliveryDate;/** 计划到货日期 */

    @TableField(exist = false)
    @JsonFormat(pattern = "yyyy-MM-dd")
    private Date receiveDate;/** 收货日期(送货单) */

    @TableField(exist = false)
    @JsonFormat(pattern = "yyyy-MM-dd")
    private Date deliveryNoteCreatedTime;/** 创建日期(送货单) */

    @TableField(exist = false)
    private String inventoryCode;/** 存货编码 */

    @TableField(exist = false)
    private String deliveryNoteVoucherNo;/** 流水号(送货单) */
    ...
    @TableField(exist = false)
    private String deliveryNoteVoucherNoSub;/** 流水号(送货单,去掉前两位字母) */
    ...
    @TableField(exist = false)
    private String warehouseErpCode;/** 仓库ERP编码 */
    ...
    @TableField(exist = false)
    private Date deliveryDate;/** 导出送货日期 */

    @TableField(exist = false)
    private String receiveUserName;/** 导出收货人姓名 */

    @TableField(exist = false)
    private String deliveryPersonName;/** 导出送货人姓名 */
    ...
    /** 主键 */
    public Long getDeliveryNoteDetailId(){
        return this.deliveryNoteDetailId;
    }
    /** 主键 */
    public void setDeliveryNoteDetailId(Long deliveryNoteDetailId){
    ...
    public String getDeliveryNoteVoucherNo() {
        return this.deliveryNoteVoucherNo;
    }
    /** 流水号(送货单) */
    public void setDeliveryNoteVoucherNo(String deliveryNoteVoucherNo) {
        this.deliveryNoteVoucherNo = deliveryNoteVoucherNo;
    }
    /** 供应商编码 */
    ...
    public String getRawMaterialFurnaceNumber() {
        return rawMaterialFurnaceNumber;
    }

    public void setRawMaterialFurnaceNumber(String rawMaterialFurnaceNumber) {
        this.rawMaterialFurnaceNumber = rawMaterialFurnaceNumber;
    }
    ...
    public Integer getBqNumber() {
        return bqNumber;
    }

    public void setBqNumber(Integer bqNumber) {
    ...
    public String getWarehouseErpCode() {
        return warehouseErpCode;
    }

    public void setWarehouseErpCode(String warehouseErpCode) {
    ...
    public String getDeliveryNoteVoucherNoSub() {
        return deliveryNoteVoucherNoSub;
    }

    public void setDeliveryNoteVoucherNoSub(String deliveryNoteVoucherNoSub) {
        this.deliveryNoteVoucherNoSub = deliveryNoteVoucherNoSub;
    }

    public Date getDeliveryNoteCreatedTime() {
        return deliveryNoteCreatedTime;
    }

    public void setDeliveryNoteCreatedTime(Date deliveryNoteCreatedTime) {
        this.deliveryNoteCreatedTime = deliveryNoteCreatedTime;
    }
