...
@TableName("bsc_stock_group")
@KeySequence("bsc_stock_group")
public class StockGroupEO extends  AbstractAuditableEntity<StockGroupEO> {
    ...
    @BusinessLogField("库存编码")
    private String groupCode;/** 库存编码 */
